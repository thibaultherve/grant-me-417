        ...
        <div className="prose prose-sm prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ReGranted ("we", "us", "our") is a free web application operated
              by Thibault Herv&eacute;, an individual based in France. This
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              European General Data Protection Regulation (GDPR), the Australian
          ...
          <section>
            ...
            <ul className="text-muted-foreground space-y-1">
              <li>
                <strong className="text-foreground">Name:</strong> Thibault
                Herv&eacute;
              </li>
              <li>
                <strong className="text-foreground">Email:</strong>{' '}
                privacy@getgranted.com
              </li>
              <li>
                <strong className="text-foreground">Location:</strong> France
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              <li>
                ...
                identify your account and communicate with you
              </li>
              <li>
                <strong className="text-foreground">Password</strong> — stored
                as a cryptographic hash (bcrypt); we never store or access your
                plain-text password
              </li>
              <li>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              <li>
                ...
                (country code) — to determine WHV 417 visa eligibility rules
              </li>
              <li>
                <strong className="text-foreground">
                  UK citizen exemption status
                </strong>{' '}
                — to apply specific visa rules
              </li>
            </ul>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              ...
              <li>
                Days required, days worked, and progress (calculated by the
                Service)
              </li>
            </ul>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              <li>
                ...
                — to keep you securely logged in (stored as hashed values)
              </li>
              <li>
                <strong className="text-foreground">Server logs</strong> — IP
                address, browser type, and access timestamps (retained for
                security purposes)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              <li>
                ...
                <em>Performance of contract (Art. 6(1)(b))</em>
              </li>
              <li>
                Calculate visa progress and eligibility —{' '}
                <em>Performance of contract (Art. 6(1)(b))</em>
              </li>
              <li>
                Authenticate your account and ensure security —{' '}
                <em>Legitimate interest (Art. 6(1)(f))</em>
              </li>
              <li>
            ...
            <p className="text-muted-foreground leading-relaxed mt-3">
              <strong className="text-foreground">We do NOT</strong> sell your
              data, use it for advertising, share it with third parties for
              their own purposes, or make automated decisions that affect you.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <strong className="text-foreground">Railway</strong> (cloud
              hosting provider, Helsinki, Finland — EU) as strictly necessary to
              operate the Service. We do not share your data with any other
              third parties.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              <li>
                Data is stored on servers in Helsinki, Finland (European Union)
              </li>
              <li>All data is encrypted in transit (TLS/HTTPS) and at rest</li>
              <li>Passwords are stored using bcrypt hashing</li>
              <li>
                JWT-based authentication with short-lived access tokens (15
                minutes) and refresh token rotation
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              <li>
                Account, visa, employer, and work entry data — retained until
                you delete your account
              </li>
              <li>
                Authentication tokens — automatically expired (7 days for
                refresh tokens)
              </li>
          ...
          <section>
            ...
            <ul className="text-muted-foreground list-disc pl-5 space-y-1">
              ...
              <li>
                Right to lodge a complaint with the CNIL (France) or your local
                DPA
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Your data is stored in the European Union (Helsinki, Finland). If
              you access the Service from outside the EU, your data is
              transferred to and stored in the EU, which provides a high
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              authentication. We do not use tracking, advertising, or analytics
              cookies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              changes will be notified via email or through the Service.
            </p>
          </section>
