...
export const WeeklyProgressChart = () => {
  ...
  const chartData: ChartData[] = weeklyProgress.map((week) => {
    ...
    return {
      week: weekLabel,
      eligibleDays: week.eligibleDays,
      hours: week.hours,
      eligibleHours: week.eligibleHours,
          ...
          >
            ...
            <div className="absolute inset-0 flex items-end justify-around px-2 overflow-x-auto">
              {chartData.map((data, index) => {
                const barHeight =
                  (data.eligibleDays / maxDays) * (chartHeight - 20);
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        cursor: data.eligibleDays > 0 ? 'pointer' : 'default',
